...
最后一步：让数据“活”起来！在任何笔记中插入以下DataviewJS代码块，它会自动加载Chart.js库，生成多种图表和统计。**这个代码超长的说**，建议在右侧的菜单栏或按快捷键到底部(电脑用户），一共有`270`行。什么？你在使用手机？那还看啥啊，复制代码先！噢对了，我想问下在座的各位大佬，这代码怎么折叠？教教我呗，可以吗？拜托了😭。
