...
最后一步：让数据“活”起来！在任何笔记中插入以下DataviewJS代码块，它会自动加载Chart.js库，生成多种图表和统计。**这个代码超长的说**，建议点击右侧的菜单栏或按快捷键到底部(电脑用户），一共有`600`行！什么？你是手机用户...那你还看啥啊，用电脑复制代码先啊！噢对了，我想问一下在座的各位大佬，这代码怎么折叠啊？教教我呗，可以吗？拜托了

有了，点这个，快速到底部，手机用户有救了。➡️[跳转至代码末尾](#结语)
